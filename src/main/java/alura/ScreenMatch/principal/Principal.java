...
import alura.ScreenMatch.model.DadosEpisodio;
...
//              .toList();
        ...
        dadosEpisodios.stream()
                ...
                .limit(10)
                .peek(e-> System.out.println("Terceiro filtro(Limitar) " + e))
        ...
        System.out.println("A partir de que ano você desejva ver os episódios");
